  ...
  return (
    <div style={{ minWidth: '900px' }}>
      ...
      >
        ...
        <Item span={4} label={<Text strong>BILL TO</Text>}>
        ...
        <Item span={2} label={<Text strong>INVOICE INFO</Text>}>
        ...
        <Item span={4} label={<Text strong>PARTICULARS</Text>}>
        ...
        <Item span={1} label={<Text strong>AREA ({data.unit.toUpperCase()})</Text>}>
          <Text>{`${data.area}`}</Text>
        </Item>
        <Item span={1} label={<Text strong>RATE/ {data.unit.toUpperCase()}</Text>}>
          <Text>
            ₹ {data.per_rate.toString().replace(/\B(?=(?:(\d\d)+(\d)(?!\d))+(?!\d))/g, ',')}
          </Text>
        </Item>
        <Item span={1} label={<Text strong>TAXABLE AMOUNT</Text>}>
          <Text>{`₹ ${data.taxable_amount
            .toString()
            .replace(/\B(?=(?:(\d\d)+(\d)(?!\d))+(?!\d))/g, ',')}`}</Text>
        </Item>

        <Item span={3} label={<Text strong>APPLIED TAX TYPE</Text>}>
        ...
        <Item span={3} label={<Text strong>TAX VALUE</Text>}>
          {!data.isSameState ? (
        ...
        <Item span={3} label={<Text strong>TOTAL TAX VALUE</Text>}>
          ₹ {data.tax_amount.toString().replace(/\B(?=(?:(\d\d)+(\d)(?!\d))+(?!\d))/g, ',')}
        </Item>

        <Item span={3} label={<Text strong>TOTAL PAYABLE AMOUNT</Text>}>
