...
/**
 * The privilege of the current user, if the empty representative is not logged in
 * current user access， if is '', user need login
 * If it is the preview of Pro, the default is permission
 */
